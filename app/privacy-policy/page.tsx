    ...
    <div className="site-container pb-20 pt-14">
      ...
      <section className="mt-10 space-y-5 reveal delay-1">
        ...
        <article className="paper-card p-6">
          ...
          <p className="mt-3 text-stone-700">
            Данните се обработват за отговор на запитвания, предварителна
            комуникация по казус и изпълнение на законови задължения.
            Обработването се извършва на основание законен интерес, предприемане
            на стъпки по искане на субекта на данните и приложимо
            законодателство.
          </p>
        </article>
        ...
        <article className="paper-card p-6">
          ...
          <p className="mt-3 text-stone-700">
            Данните се съхраняват за срока, необходим за целите на
            обработването, както и за сроковете, предвидени в приложимото право.
          </p>
        </article>
        ...
        <article className="paper-card p-6">
          ...
          <p className="mt-3 text-stone-700">
            ...
            обработването, възражение и преносимост на данните, когато е
            приложимо. Можете да упражните правата си чрез контактите, посочени
            по-горе.
          </p>
        </article>
        ...
        <article className="paper-card p-6">
          ...
          <p className="mt-3 text-stone-700">
            Към момента сайтът не използва маркетингови или аналитични бисквитки
            за проследяване на потребители. При евентуално въвеждане на такива
            технологии настоящата политика ще бъде актуализирана и, когато е
            необходимо, ще бъде изисквано съгласие.
          </p>
        </article>
      </section>
    </div>
