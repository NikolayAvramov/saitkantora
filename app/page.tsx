...
const highlights = [
  "Над 15 години практика по реални казуси",
    ...
    <div>
      <section className="site-container grid gap-12 pb-20 pt-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div className="reveal">
          <span className="section-label">Правна сигурност с фокус върху резултата</span>
          ...
          <p className="mt-6 max-w-2xl text-lg text-stone-700">
            Кантората предоставя правна помощ при сложни и ежедневни казуси. Работим
            структурирано, с предварителен анализ на риска и практични решения,
            съобразени с вашите цели.
          </p>
          ...
          <ul className="mt-8 grid gap-2 text-sm text-stone-700 sm:grid-cols-3 reveal delay-2">
            {highlights.map((item) => (
              <li key={item} className="rounded-lg border border-stone-300/90 bg-[#fdf9f2] px-4 py-3 card-hover">
                {item}
              </li>
            ))}
          </ul>
        ...
        <aside className="paper-card p-7 card-hover reveal delay-3">
          ...
          <h2 className="mt-3 text-2xl font-semibold text-stone-900">Как работим</h2>
          <ol className="mt-5 space-y-4 text-sm text-stone-700">
            <li>
              <strong className="text-stone-900">1. Първичен анализ:</strong> преглеждаме
              фактите, документите и правната рамка.
            </li>
            <li>
              <strong className="text-stone-900">2. План по казуса:</strong> получавате
              конкретни стъпки, срокове и очаквани резултати.
            </li>
            <li>
              <strong className="text-stone-900">3. Представителство:</strong> защита на
              интереса ви при преговори и пред институции.
            </li>
          </ol>
        </aside>
      </section>
      ...
      <section className="border-y border-stone-300/80 bg-[#f7f1e6] py-16 reveal">
        <div className="site-container">
          <h2 className="title-accent text-3xl font-semibold text-stone-900 md:text-4xl">Основни практики</h2>
          <p className="mt-3 max-w-2xl text-stone-700">
            Поддържаме стабилна практика в ключови правни направления и работим по
            казуси с висока фактическа и правна сложност.
          </p>

          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {services.map((service) => (
              <article key={service.title} className="paper-card p-6 card-hover">
