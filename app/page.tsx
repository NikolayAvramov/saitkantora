      ...
      <section className="site-container grid gap-12 pb-20 pt-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div className="reveal">
          ...
          <p className="mt-6 max-w-2xl text-lg text-stone-700">
            Кантората предоставя правна помощ при сложни и ежедневни казуси.
            Работим структурирано, с предварителен анализ на риска и практични
            решения, съобразени с вашите цели.
          </p>
