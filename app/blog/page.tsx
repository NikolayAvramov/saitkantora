...
export const metadata: Metadata = {
  title: "Публикации",
  description:
    "Практически статии и правни анализи от адвокат Красимир Бънчев по наследствено, търговско и трудово право.",
  keywords: [
    "правен блог",
    "правни статии",
    "наследствено право статии",
    "трудово право статии",
    "търговско право статии",
  ],
  alternates: {
    canonical: "/blog",
  },
